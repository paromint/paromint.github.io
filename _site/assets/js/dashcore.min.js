 ...
 *
 * Copyright 2018, 5Studios.net https://www.paromint.com
  ...
  (function() {
    $(".whyus-progress-bars").animateBar({
      ...
      elements: [
        ...
        { label: "Implementation", value: 91, style: { progress: "progress-xs" } },
        { label: "High Availability", value: 97, style: { progress: "progress-xs" } },
        { label: "Distributed", value: 61, style: { progress: "progress-xs" } },
        {
